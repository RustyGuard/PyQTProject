...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wordStart.setGeometry(QtCore.QRect(610, 280, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(12)
        ...
        self.listWidget.setGeometry(QtCore.QRect(610, 10, 351, 211))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(12)
        ...
        self.b0.setGeometry(QtCore.QRect(10, 640, 51, 51))
        font = QtGui.QFont()
        ...
        self.b1.setGeometry(QtCore.QRect(70, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.b2.setGeometry(QtCore.QRect(130, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.b3.setGeometry(QtCore.QRect(190, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.b4.setGeometry(QtCore.QRect(250, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.b5.setGeometry(QtCore.QRect(310, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.b6.setGeometry(QtCore.QRect(370, 640, 51, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(14)
        ...
        self.turnCancel.setGeometry(QtCore.QRect(790, 340, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(12)
        ...
        self.turnEnd.setGeometry(QtCore.QRect(610, 340, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(12)
        ...
        self.comboBox.setGeometry(QtCore.QRect(830, 230, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        ...
        self.wordEnd.setGeometry(QtCore.QRect(790, 280, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(12)
        ...
        self.cursorLet.setGeometry(QtCore.QRect(430, 640, 231, 51))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        ...
        self.wordX = QtWidgets.QScrollBar(self.centralwidget)
        self.wordX.setGeometry(QtCore.QRect(10, 580, 571, 16))
        self.wordX.setMaximum(15)
        self.wordX.setOrientation(QtCore.Qt.Horizontal)
        self.wordX.setObjectName("wordX")
        self.wordY = QtWidgets.QScrollBar(self.centralwidget)
        self.wordY.setGeometry(QtCore.QRect(580, 10, 21, 571))
        ...
        self.wordLen.setGeometry(QtCore.QRect(610, 230, 171, 31))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(610, 390, 351, 191))
